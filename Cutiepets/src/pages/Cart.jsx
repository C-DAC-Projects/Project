...
const Cart = () => {
    ...
    const [addresses, setAddresses] = useState(dummyProducts);
    ...
    return products.length > 0 && cartItems ? (
        <div className="flex flex-col md:flex-row mt-30 ml-5">
                    ...
                    <div key={index} className="grid grid-cols-[2fr_1fr_1fr] text-gray-500 items-center text-sm md:text-base font-medium pt-3">
                        <div className="flex items-center md:gap-6 gap-3">
                            ...
                            <div>
                                ...
                                <div className="font-normal text-white-500/70">
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        <p className="text-white-500">{selectedAddress ? `${selectedAddress.street}, ${selectedAddress.city}, ${selectedAddress.state}` : "No Address Found" }</p>
                    ...
                    <select onChange={e => setPaymentOption(e.target.value)} className="w-full border border-gray-300 bg-black px-3 py-2 mt-2 outline-none">
                ...
                <div className="text-white-500 mt-4 space-y-2">
